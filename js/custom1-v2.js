;(function () {
  ...
  var selectEventInfo = function(column){
    ...
    $('[role=description]', mainBlock).text(infoObj.description);
    var imageUrl = infoObj.image.length ? infoObj.image : 'images/events/some_pic.png'

    $('[role=image]', mainBlock).attr('src', imageUrl);
